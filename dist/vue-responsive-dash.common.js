...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DashItem_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("7e8e");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DashItem_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DashItem_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DashItem_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Dashboard_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("02ce");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Dashboard_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Dashboard_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Dashboard_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"3ccd325e-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/DashItem.vue?vue&type=template&id=6590ad11&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.item)?_c('div',{ref:_vm.id,staticClass:"item",class:_vm.classObj,style:({
    ...
    top: _vm.top + 'px'
      ...
      position: 'absolute',
      cursor: 'move'
    }),attrs:{"draggable":"","id":_vm.id + '-overlay'},on:{"dragstart":function($event){$event.stopPropagation();return _vm.onDragStart($event)},"drag":function($event){$event.stopPropagation();return _vm.onDrag($event)},"dragend":function($event){$event.stopPropagation();return _vm.onDragEnd($event)}}},[(_vm.resizeTop && !_vm.dragging)?_c('div',{ref:_vm.id + '-resizeTop',style:({
        height: _vm.resizeHandleSize + 'px',
        left: 0,
        right: 0,
        cursor: 'ns-resize',
        position: 'absolute'
      }),attrs:{"draggable":"","id":_vm.id + '-resizeTop'},on:{"dragstart":function($event){$event.stopPropagation();return _vm.onResizeStart($event, 'top')},"drag":function($event){$event.stopPropagation();return _vm.onResize($event, 'top')},"dragend":function($event){$event.stopPropagation();return _vm.onResizeEnd($event, 'top')}}},[_vm._t("resizeTop")],2):_vm._e(),(_vm.resizeBottom && !_vm.dragging)?_c('div',{ref:_vm.id + '-resizeBottom',style:({
        height: _vm.resizeHandleSize + 'px',
        left: 0 + 'px',
        right: 0 + 'px',
        bottom: 0 + 'px',
        cursor: 'ns-resize',
        position: 'absolute'
      }),attrs:{"draggable":"","id":_vm.id + '-resizeBottom'},on:{"dragstart":function($event){$event.stopPropagation();return _vm.onResizeStart($event, 'bottom')},"drag":function($event){$event.stopPropagation();return _vm.onResize($event, 'bottom')},"dragend":function($event){$event.stopPropagation();return _vm.onResizeEnd($event, 'bottom')}}},[_vm._t("resizeBottom")],2):_vm._e(),(_vm.resizeLeft && !_vm.dragging)?_c('div',{ref:_vm.id + '-resizeLeft',style:({
        ...
        cursor: 'ew-resize',
        position: 'absolute'
      }),attrs:{"draggable":"","id":_vm.id + '-resizeLeft'},on:{"dragstart":function($event){$event.stopPropagation();return _vm.onResizeStart($event, 'left')},"drag":function($event){$event.stopPropagation();return _vm.onResize($event, 'left')},"dragend":function($event){$event.stopPropagation();return _vm.onResizeEnd($event, 'left')}}},[_vm._t("resizeLeft")],2):_vm._e(),(_vm.resizeRight && !_vm.dragging)?_c('div',{ref:_vm.id + '-resizeRight',style:({
        width: _vm.resizeHandleSize + 'px',
        top: 0 + 'px',
        bottom: 0 + 'px',
        right: 0 + 'px',
        cursor: 'ew-resize',
        position: 'absolute'
      }),attrs:{"draggable":"","id":_vm.id + '-resizeRight'},on:{"dragstart":function($event){$event.stopPropagation();return _vm.onResizeStart($event, 'right')},"drag":function($event){$event.stopPropagation();return _vm.onResize($event, 'right')},"dragend":function($event){$event.stopPropagation();return _vm.onResizeEnd($event, 'right')}}},[_vm._t("resizeRight")],2):_vm._e(),(_vm.resizeTopLeft && !_vm.dragging)?_c('div',{ref:_vm.id + '-resizeTopLeft',style:({
        ...
        cursor: 'nw-resize',
        position: 'absolute'
      }),attrs:{"draggable":"","id":_vm.id + '-resizeTopLeft'},on:{"dragstart":function($event){$event.stopPropagation();return _vm.onResizeStart($event, 'top left')},"drag":function($event){$event.stopPropagation();return _vm.onResize($event, 'top left')},"dragend":function($event){$event.stopPropagation();return _vm.onResizeEnd($event, 'top left')}}},[_vm._t("resizeTopLeft")],2):_vm._e(),(_vm.resizeTopRight && !_vm.dragging)?_c('div',{ref:_vm.id + '-resizeTopRight',style:({
        width: _vm.resizeHandleSize * 2 + 'px',
        height: _vm.resizeHandleSize * 2 + 'px',
        top: _vm.resizeHandleSize / -2 + 'px',
        ...
        cursor: 'ne-resize',
        position: 'absolute'
      }),attrs:{"draggable":"","id":_vm.id + '-resizeTopRight'},on:{"dragstart":function($event){$event.stopPropagation();return _vm.onResizeStart($event, 'top right')},"drag":function($event){$event.stopPropagation();return _vm.onResize($event, 'top right')},"dragend":function($event){$event.stopPropagation();return _vm.onResizeEnd($event, 'top right')}}},[_vm._t("resizeTopRight")],2):_vm._e(),(_vm.resizeBottomLeft && !_vm.dragging)?_c('div',{ref:_vm.id + '-resizeBottomLeft',style:({
        width: _vm.resizeHandleSize * 2 + 'px',
        height: _vm.resizeHandleSize * 2 + 'px',
        ...
        cursor: 'ne-resize',
        position: 'absolute'
      }),attrs:{"draggable":"","id":_vm.id + '-resizeBottomLeft'},on:{"dragstart":function($event){$event.stopPropagation();return _vm.onResizeStart($event, 'bottom left')},"drag":function($event){$event.stopPropagation();return _vm.onResize($event, 'bottom left')},"dragend":function($event){$event.stopPropagation();return _vm.onResizeEnd($event, 'bottom left')}}},[_vm._t("resizeBottomLeft")],2):_vm._e(),(_vm.resizeBottomRight && !_vm.dragging)?_c('div',{ref:_vm.id + '-resizeBottomRight',style:({
        width: _vm.resizeHandleSize * 2 + 'px',
        height: _vm.resizeHandleSize * 2 + 'px',
        bottom: _vm.resizeHandleSize / -2 + 'px',
        right: _vm.resizeHandleSize / -2 + 'px',
        cursor: 'nw-resize',
        position: 'absolute'
      }),attrs:{"draggable":"","id":_vm.id + '-resizeBottomRight'},on:{"dragstart":function($event){$event.stopPropagation();return _vm.onResizeStart($event, 'bottom right')},"drag":function($event){$event.stopPropagation();return _vm.onResize($event, 'bottom right')},"dragend":function($event){$event.stopPropagation();return _vm.onResizeEnd($event, 'bottom right')}}},[_vm._t("resizeBottomRight")],2):_vm._e()]):_vm._e(),_vm._t("default")],2):_vm._e()}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/DashItem.vue?vue&type=template&id=6590ad11&
...
/* harmony default export */ var DashItemvue_type_script_lang_js_ = ({
  ...
  methods: {
    onDragStart: function () {
      var _onDragStart = _asyncToGenerator(
      /*#__PURE__*/
    ...
    onDragEnd: function () {
      var _onDragEnd = _asyncToGenerator(
      /*#__PURE__*/
    ...
    onResizeStart: function onResizeStart(event, location) {
      this.resizing = true;
    ...
    onResize: function onResize(event, location) {
      this.item._onResize(event, location);

      this.$emit("resize", this.item);
    },
    onResizeEnd: function () {
      var _onResizeEnd = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee3(event, location) {
      ...
      function onResizeEnd(_x3, _x4) {
        return _onResizeEnd.apply(this, arguments);
      }
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"3ccd325e-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Layout.vue?vue&type=template&id=1d0d59cb&
var Layoutvue_type_template_id_1d0d59cb_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.currentBreakpoint === _vm.breakpoint),expression:"currentBreakpoint === breakpoint"}]},[(_vm.l)?_c('div',{style:({ position: 'relative', height: _vm.height })},[_vm._t("default"),_c('DashItem',{directives:[{name:"show",rawName:"v-show",value:(_vm.dragging || _vm.resizing),expression:"dragging || resizing"}],attrs:{"id":_vm.placeholderId,"draggable":false,"resizeable":false}},[_c('div',{staticClass:"placeholder"})])],2):_vm._e(),(_vm.debug)?_c('div',[_vm._v(" Layout Breakpoint: "+_vm._s(_vm.breakpoint)+" "),_c('br'),_vm._v(" Current ColWidth: "+_vm._s(_vm.colWidth)+" "),_c('br'),_vm._v(" Layout Number of Cols: "+_vm._s(_vm.numberOfCols)+" "),_c('br'),_vm._v(" placeholder: "+_vm._s(JSON.stringify(_vm.placeholder))+" "),_c('br'),_vm._v(" Items: "+_vm._s(JSON.stringify(_vm.itemsFromLayout))+" ")]):_vm._e()])}
var Layoutvue_type_template_id_1d0d59cb_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Layout.vue?vue&type=template&id=1d0d59cb&
...
var Layoutvue_type_script_lang_js_watchProp = function watchProp(key, deep) {
  return {
    handler: function handler(newValue) {
      //If the prop did not cause the update there is no updating
...
/* harmony default export */ var Layoutvue_type_script_lang_js_ = ({
  ...
  methods: {
    createPropWatchers: function createPropWatchers() {
      ...
      //Setup prop watches to sync with the Dash Item
      Object.keys(this.$props).forEach(function (key) {
        _this2.$watch(key, Layoutvue_type_script_lang_js_watchProp(key, true));
      });
    }
  },
  created: function created() {
    this.l = new Layout_model_Layout(this.$props);
...
// EXTERNAL MODULE: ./src/components/Layout.vue?vue&type=style&index=0&lang=css&
var Layoutvue_type_style_index_0_lang_css_ = __webpack_require__("895a");
...
var Layout_component = normalizeComponent(
  ...
  Layoutvue_type_template_id_1d0d59cb_render,
  Layoutvue_type_template_id_1d0d59cb_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var components_Layout = (Layout_component.exports);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"3ccd325e-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Dashboard.vue?vue&type=template&id=bedab2be&
var Dashboardvue_type_template_id_bedab2be_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[(_vm.d)?_c('div',{directives:[{name:"rlocal",rawName:"v-rlocal"}],ref:_vm.id,attrs:{"id":_vm.id},on:{"resize":_vm.onResize}},[_vm._t("default")],2):_vm._e()])}
var Dashboardvue_type_template_id_bedab2be_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Dashboard.vue?vue&type=template&id=bedab2be&
...
function () {
  ...
  _createClass(Dashboard, [{
    ...
    key: "setMargins",
    value: function setMargins(m) {
      this.margin = m; //this.updateResponsiveVariables();
    }
  }, {
    key: "sortBreakpoints",
...
// EXTERNAL MODULE: ./src/components/Dashboard.vue?vue&type=style&index=0&lang=css&
var Dashboardvue_type_style_index_0_lang_css_ = __webpack_require__("2fe3");
...
var Dashboard_component = normalizeComponent(
  ...
  Dashboardvue_type_template_id_bedab2be_render,
  Dashboardvue_type_template_id_bedab2be_staticRenderFns,
  false,
  null,
  null,
  null
