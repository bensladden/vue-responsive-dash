(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fusioncharts"] = factory(require("vue"));
	else
		root["fusioncharts"] = factory(root["Vue"]);
...
/* harmony default export */ var FusionChartvue_type_script_lang_js_ = ({
  inject: ["$item"],
  props: ["type", "dataFormat", "dataSource"],
  computed: {
    item() {
      return this.$item();
    },
...
// CONCATENATED MODULE: ./src/components/FusionChart.vue
...
var component = normalizeComponent(
  components_FusionChartvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var FusionChart = (component.exports);
...
Object.keys(VueResponsiveDashFusioncharts).forEach(name => {
  external_commonjs_vue_commonjs2_vue_root_Vue_default.a.component(name, VueResponsiveDashFusioncharts[name]);
});
...
//# sourceMappingURL=fusioncharts.umd.js.map