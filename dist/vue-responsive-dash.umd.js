...
function indexOfDeepestElement(elements) {
  ...
  for (i = 1; i < elements.length; i++) {
    ...
    if (deepestZone instanceof utils_domObjects.HTMLElement && dropzone instanceof utils_domObjects.SVGElement && !(dropzone instanceof utils_domObjects.SVGSVGElement)) {
...
function resize_plugin_install(scope) {
  ...
  Interactable.prototype.resizable = function (options) {
    return plugin_resizable(this, options, scope);
  };
...
function plugin_resizable(interactable, options, scope) {
  if (is.object(options)) {
